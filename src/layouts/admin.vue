        ...
        >
          ...
          <div class="text-center p-1" :style="{'background':bgleft2}" style="z-index:100;">
            ...
            <ul class="isaktif sm:pl-4 anim mb-3 text-white animated slideInRight ">
              <li class="bord hover:bg-red text-left sm:pl-3" style="font-size:11px;" @click="$router.push('/driver/admin/user')">&nbsp;&nbsp;User&nbsp;&nbsp;<span class="typcn typcn-user"></span></li>
              <li class="bord hover:bg-red text-left sm:pl-3" style="font-size:11px;" @click="$router.push('/driver/admin/mobil')">&nbsp;&nbsp;Mobil&nbsp;&nbsp;<span class="typcn typcn-calculator"></span></li>
              <li class="bord hover:bg-red text-left sm:pl-3" style="font-size:11px;" @click="$router.push('/driver/admin/perjalanan')">&nbsp;&nbsp;Data Ijin Keluar&nbsp;&nbsp;<span class="typcn typcn-download"></span></li>
              <li class="bord hover:bg-red text-left sm:pl-3" style="font-size:11px;" @click="$router.push('/driver/admin/no_hp')">&nbsp;&nbsp;No HP LAPORAN&nbsp;&nbsp;<span class="typcn typcn-headphones"></span></li>
              <li class="bord hover:bg-red text-left sm:pl-3" style="font-size:11px;" @click="$router.push('/driver/admin/lembur')">&nbsp;&nbsp;Data Lembur&nbsp;&nbsp;<span class="typcn typcn-pi-outline"></span></li>
              <li class="bord hover:bg-red text-left sm:pl-3" style="font-size:11px;" @click="$router.push('/driver/admin/unit')">&nbsp;&nbsp;Unit&nbsp;&nbsp;<span class="typcn typcn-sort-alphabetically-outline"></span></li>
            </ul>
            <div
          ...
          <div class="row">
            ...
            <div class="col-sm-12" style="padding:0;margin:0;position:fixed;z-index:100;">
              ...
              >
                ...
                <img src="@/static/media/icon/btn.png" class="kinoLightBox img-fluid mx-auto" style="height:30px;" @click="$router.push('/driver/admin')">
                </div>
                <template class>
