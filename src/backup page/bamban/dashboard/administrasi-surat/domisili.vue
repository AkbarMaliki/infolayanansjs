  ...
  <div>
    <div class="bg-white rounded-lg mb-4 p-4" style="font-family:times new roman;">
      <span style="font-size:20px;text-transform:none;color:black;">
        ...
        <router-link to="/dashboard/administrasi-surat/domisili">Domisili</router-link>
      </span>
      <br />
      <br />
      ...
      <hr class="style13" />
      <tables :datanya="datanya" :unless="['fname','lname']" @go="test" />
      <!-- ,'DomisiliID','PendudukID','PerangkatID','tgl1','Pekerjaan','Alamat','Kwn' -->
    </div>
  </div>
</template>
<script>
import tables from "@/components/app/table/table_domisili.vue";
