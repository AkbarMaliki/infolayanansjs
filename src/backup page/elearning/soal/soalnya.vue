      ...
      <tr>
        ...
        <td>
          <div class="sm-form">
            <input
              type="text"
              placeholder="pertanyaan_"
              id="pertanyaan"
              name="pertanyaan"
              class="form-control form-control-sm"
              v-model="vdata.pertanyaan"
              pattern="[a-zA-Z0-9\s]+"
              minlength="0"
              maxlength="30"
              oninvalid="this.setCustomValidity('Harus diisi dan Maksimal 30 !')"
      ...
      <tr>
        ...
        <td>
          <div class="sm-form">
            <input
              type="text"
              placeholder="orderBy_"
              id="orderBy"
              name="orderBy"
              class="form-control form-control-sm"
              v-model="vdata.orderBy"
              pattern="[a-zA-Z0-9\s]+"
              minlength="0"
              maxlength="30"
              oninvalid="this.setCustomValidity('Harus diisi dan Maksimal 30 !')"
...
export default {
  ...
  methods: {
    insert() {
      ...
      fd.append(
        "data",
        `Insert into tsoal (pertanyaan,img,type,benar,orderBy) VALUES ('${this.vdata.pertanyaan}','${this.vdata.img}','${this.vdata.type}','${this.vdata.benar}','${this.vdata.orderBy}')`
      );
      fd.append("database", "elearning2");
    ...
    update() {
      ...
      fd.append(
        "data",
        `UPDATE tsoal SET pertanyaan='${this.vdata.pertanyaan}',img='${this.vdata.img}',type='${this.vdata.type}',benar='${this.vdata.benar}',orderBy='${this.vdata.orderBy}' Where id = '${this.vdata.id}'`
      );
      fd.append("database", "elearning2");
      this.$nuxt.$emit("busy", true);
      axios
    ...
    remove() {
      ...
      fd.append("data", `DELETE FROM tsoal WHERE  id =  '${this.vdata.id}'`);
      fd.append("database", "elearning2");
    ...
    refreshData() {
      ...
      fd2.append("data", "select * from tsoal"); //if empty = *
      fd2.append("table", "tsoal");
      fd2.append("database", "elearning2");
      fd2.append("aksi", "select");
      axios
        .post(this.$store.state.database + "/api/mysql/auto.php", fd2, {
          headers: {
            Authorization: localStorage.getItem("auth._token.local")
          }
        })
