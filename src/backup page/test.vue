<template>
  <div class="font-times">
    <!-- FORM -->
      ...
      <p class="text-center text-uppercase pb-3">sukubunga</p>
    ...
    >
      <!-- FORM --> 
          <tr>
              <td class='text-uppercase text-sm'>ids_</td>
              <td>&nbsp;:&nbsp;</td>
          ...
          <tr>
              <td class='text-uppercase text-sm'>title_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>sub_kiri_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="sub_kiri_"
                    id="sub_kiri"
                    name="sub_kiri"
                    class="form-control form-control-sm"
          ...
          <tr>
              <td class='text-uppercase text-sm'>sub_kanan_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="sub_kanan_"
                    id="sub_kanan"
                    name="sub_kanan"
                    class="form-control form-control-sm"
        ...
        <div class="w-full sm:w-1/3">
          <div class="row">
            <div class="col-sm-3 order-2">
              <a :href="`https://infolayanans.space/api/mysql/excel.php?data=select ids,title,sub_kiri,sub_kanan from sukubunga&database= infolay3_test`" class="btn-lg btn-success" ><span class="typcn typcn-chart-bar"></span></a>
              <download-excel
                :data='td'>
          ...
          >
            ...
            <tbody>
              <tr v-for="(item, index3) in td" :key="index3+'td'">
                  ...
                  <input
                    type="checkbox"
                    :id="item.ids+index3+'check'"
                    :value="item.ids"
                    v-model="checkedItem"
                  />
                  <label :for="item.ids+index3+'check'">{{item.ids}}</label>
                </td>
  ...
  methods: {
    insert(){
          ...
          if(confirm('Apakah yakin menghapus data?')){
              db.collection("sukubunga").doc(this.pilih.ids).delete()
          }
      }
      ,ambil(item, index) {
      window.scrollTo(0, 0);
