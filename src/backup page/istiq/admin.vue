      ...
      <div class="row">
        <div class="col-sm-12">
          <img
            ...
            class="kinoLightBox img-fluid rounded-circle z-depth-2 mx-auto"
        ...
        <div class="offset-sm-2 col-sm-8">
          <div class="row">
            <div class="col-sm-4">
              <button
                ...
                class="btn btn-sm btn-outline-danger text-uppercase btn-block"
              >insert</button>
            </div>
            <div class="col-sm-4">
              <button
          ...
          >
            ...
            <tr>
              ...
              <td>
                <button class="btn btn-sm btn-warning" @click="inputfile">Set Gambar</button>
              </td>
            </tr>
            <br />
            <!-- FORM -->
            ...
            <button
              type="submit"
              class="btn btn-sm btn-outline-primary ml-2 btn-block text-uppercase"
...
export default {
  ...
  methods: {
    ...
    insert() {
      ...
      fd.append(
        "data",
        `Insert into istiq_baju (name,S_M,L_XL,XXL,bahan,gambar) VALUES ('${this.vdata.name}','${this.vdata.S_M}','${this.vdata.L_XL}','${this.vdata.XXL}','${this.vdata.bahan}','${this.vdata.gambar}')`
      );
    ...
    update() {
      ...
      fd.append(
        "data",
        `UPDATE istiq_baju SET name='${this.vdata.name}',S_M='${this.vdata.S_M}',L_XL='${this.vdata.L_XL}',XXL='${this.vdata.XXL}',bahan='${this.vdata.bahan}',gambar='${this.vdata.gambar}' Where id = '${this.vdata.id}'`
      );
      fd.append("database", " infolay3_test");
    ...
    remove() {
      ...
      fd.append(
        "data",
        `DELETE FROM istiq_baju WHERE  id =  '${this.vdata.id}'`
      );
      fd.append("database", " infolay3_test");
    ...
    refreshData() {
      ...
      fd2.append("data", "select * from istiq_baju"); // if empty = *
      fd2.append("table", "istiq_baju");
