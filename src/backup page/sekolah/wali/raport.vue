<template>
  <div class="font-times">
    <!-- FORM -->
      <p class="text-center text-uppercase pb-3">RAPORT</p>
      
      <div class="row" >
        <div class="col-sm-12">
          <p class="text-center font-bold">{{td[0].nama_siswa}}</p>
          <div  v-for="(item, index) in td" :key="index+'td'">
            <p class="pl-2 pt-2">Mata Pelajaran : <span class="font-bold">{{item.nama_pelajaran}}</span> </p>
            <p class="pl-2">Nilai Rata rata tugas : {{item.rata_tugas}}</p>
            <p class="pl-2">Nilai Harian keseluruhan : {{item.nilai_harian}}</p>
            <p class="pl-2">Nilai UTS : {{item.nilai_uts}}</p>
            <p class="pl-2">Nilai UAS : {{item.nilai_uas}}</p>
          </div>
        </div>
      </div>
      <br>
...
export default {
  ...
  methods: {
      ...
      fd.append("data", `Insert into sekolah_nilai (id_siswa,id_pelajaran,id_jadwal,id_kelas,id_guru,nilai_uh1,nilai_uh2,nilai_uh3,nilai_uh4,nilai_uh5,rata_uh,nilai_tugas1,nilai_tugas2,nilai_tugas3,nilai_tugas4,rata_tugas,nilai_harian,nilai_uas,nilai_rapor,kkm,ket) VALUES ('${this.vdata.id_siswa}','${this.vdata.id_pelajaran}','${this.vdata.id_jadwal}','${this.vdata.id_kelas}','${this.vdata.id_guru}','${this.vdata.nilai_uh1}','${this.vdata.nilai_uh2}','${this.vdata.nilai_uh3}','${this.vdata.nilai_uh4}','${this.vdata.nilai_uh5}','${this.vdata.rata_uh}','${this.vdata.nilai_tugas1}','${this.vdata.nilai_tugas2}','${this.vdata.nilai_tugas3}','${this.vdata.nilai_tugas4}','${this.vdata.rata_tugas}','${this.vdata.nilai_harian}','${this.vdata.nilai_uas}','${this.vdata.nilai_rapor}','${this.vdata.kkm}','${this.vdata.ket}')`);
