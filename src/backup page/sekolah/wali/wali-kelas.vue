<template>
  <div class="font-times">
    <!-- FORM -->
      ...
      <div class="row" v-show="$store.state.users.pilih=='admin' || $store.state.wali">
        ...
        <div class="w-full sm:w-1/3">
          <div class="row">
            <div class="col-sm-3 order-2">
              <a :href="`https://infolayanans.space/api/mysql/excel.php?data=select id_jwalikelas,id_kelas,id_guru from sekolah_jwalikelas&database=infolay3_test`" class="btn-lg btn-success" ><span class="typcn typcn-chart-bar"></span></a>
              <download-excel
                :data='td'>
