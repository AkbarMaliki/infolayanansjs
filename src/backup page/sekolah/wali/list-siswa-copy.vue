...
export default {
  ...
  methods: {
      ...
      fd.append("data", `Insert into sekolah_data_siswa (id_kelas,nama_siswa,nis,nisn,kota,t_lahir,t_masuk,kelamin,agama,status,anakke,alamat_siswa,telpon_siswa,sekolahasal,kelas,ayah,ibu,alamatortu,hportu,pekerjaanayah,pekerjaanibu,wali,alamatwali,hpwali,pekerjaanwali) VALUES ('${this.vdata.id_kelas}','${this.vdata.nama_siswa}','${this.vdata.nis}','${this.vdata.nisn}','${this.vdata.kota}','${this.vdata.t_lahir}','${this.vdata.t_masuk}','${this.vdata.kelamin}','${this.vdata.agama}','${this.vdata.status}','${this.vdata.anakke}','${this.vdata.alamat_siswa}','${this.vdata.telpon_siswa}','${this.vdata.sekolahasal}','${this.vdata.kelas}','${this.vdata.ayah}','${this.vdata.ibu}','${this.vdata.alamatortu}','${this.vdata.hportu}','${this.vdata.pekerjaanayah}','${this.vdata.pekerjaanibu}','${this.vdata.wali}','${this.vdata.alamatwali}','${this.vdata.hpwali}','${this.vdata.pekerjaanwali}')`);
