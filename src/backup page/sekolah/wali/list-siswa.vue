  ...
  <div class="font-times">
    <!-- FORM -->
      <p class="text-center text-uppercase pb-3">sekolah_data_siswa</p>
       <div class="container-fluid" v-if="pilih.name!='taufik'">
          <div class="row ">
              <div class="col-sm-6 cursor-pointer animated fadeInDown" @click="$router.push(`/sekolah/wali/raport?id_siswa=${pilih.id_siswa}`)">
                  <div class="py-2 text-center bg-blue-light rounded-lg shadow-lg">
                      <p class="font-times font-bold text-uppercase"><span class="typcn typcn-document-delete"></span> Nilai : {{pilih.nama_siswa}}</p>
                  </div>
              </div>
              <div class="col-sm-6 cursor-pointer animated fadeInDown" @click="$router.push(`/sekolah/wali/raport?id_siswa=${pilih.id_siswa}`)">
                  <div class="py-2 text-center bg-red-light rounded-lg shadow-lg">
                      <p class="font-times font-bold text-uppercase"><span class="typcn typcn-document-delete"></span> Raport : {{pilih.nama_siswa}}</p>
                  </div>
              </div>
          </div>
      </div>
      <br>
      <br>
      <div class="row"  v-show="this.$store.state.users.pilih=='admin'">
        <div class="col-sm-12">
    ...
    >
      ...
      <div class="container">
          <div class="row ">
              <div class="col-sm-4">
                    <tr>
              <td class='text-uppercase text-sm'>id_siswa</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="id_siswa"
                    id="id_siswa"
                    name="id_siswa"
                    class="form-control form-control-sm shadow-md"
              ...
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <select class='form-control'  v-model="vdata.id_kelas">
                    <option v-for="(item, index) in kelas" :key="index+'siswas3'" :value="item.id_kelas">{{item.nama_kelas}}</option>
                  </select>
              </td>
            </tr>
              <tr>
              <td class='text-uppercase text-sm'>id_jurusan</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <select class='form-control'  v-model="vdata.id_jurusan">
                    <option v-for="(item, index) in jurusans" :key="index+'siswas3'" :value="item.id_jurusan">{{item.nama_jurusan}}</option>
                  </select>
              </td>
            </tr>
          <tr>
              <td class='text-uppercase text-sm'>nama_siswa</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    ...
                    name="nama_siswa"
                    class="form-control form-control-sm shadow-md"
                     required v-model="vdata.nama_siswa"
          ...
          <tr>
              <td class='text-uppercase text-sm'>nis</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>nisn</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>kota</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>t_lahir</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    ...
                    name="t_lahir"
                    class="form-control form-control-sm shadow-md"
                     required v-model="vdata.t_lahir"
          ...
          <tr>
              <td class='text-uppercase text-sm'>t_masuk</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    ...
                    name="t_masuk"
                    class="form-control form-control-sm shadow-md"
                     required v-model="vdata.t_masuk"
          ...
          <tr>
              <td class='text-uppercase text-sm'>kelamin</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                 <select class="form-control"  required v-model="vdata.kelamin">
          ...
          <tr>
              <td class='text-uppercase text-sm'>agama</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>status</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
              ...
              <div class="col-sm-4">
                    <tr>
              <td class='text-uppercase text-sm'>anakke</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>alamat_siswa</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    ...
                    name="alamat_siswa"
                    class="form-control form-control-sm shadow-md"
                     required v-model="vdata.alamat_siswa"
          ...
          <tr>
              <td class='text-uppercase text-sm'>telpon_siswa</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="telpon_siswa"
                    id="telpon_siswa"
                    name="telpon_siswa"
                    class="form-control form-control-sm shadow-md"
                     required v-model="vdata.telpon_siswa"
          ...
          <tr>
              <td class='text-uppercase text-sm'>sekolahasal</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="sekolahasal"
                    id="sekolahasal"
                    name="sekolahasal"
                    class="form-control form-control-sm shadow-md"
                     required v-model="vdata.sekolahasal"
          ...
          <tr>
              <td class='text-uppercase text-sm'>kelas</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>ayah</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>ibu</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>alamatortu</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="alamatortu"
                    id="alamatortu"
                    name="alamatortu"
                    class="form-control form-control-sm shadow-md"
                     required v-model="vdata.alamatortu"
          ...
          <tr>
              <td class='text-uppercase text-sm'>hportu</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>pekerjaanayah</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    ...
                    name="pekerjaanayah"
                    class="form-control form-control-sm shadow-md"
                     required v-model="vdata.pekerjaanayah"
              ...
              <div class="col-sm-4">
                     <tr>
              <td class='text-uppercase text-sm'>pekerjaanibu</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    ...
                    name="pekerjaanibu"
                    class="form-control form-control-sm shadow-md"
                     required v-model="vdata.pekerjaanibu"
          ...
          <tr>
              <td class='text-uppercase text-sm'>wali</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>alamatwali</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="alamatwali"
                    id="alamatwali"
                    name="alamatwali"
                    class="form-control form-control-sm shadow-md"
                     required v-model="vdata.alamatwali"
          ...
          <tr>
              <td class='text-uppercase text-sm'>hpwali</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>pekerjaanwali</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    ...
                    name="pekerjaanwali"
                    class="form-control form-control-sm shadow-md"
                     required v-model="vdata.pekerjaanwali"
...
export default {
  ...
  methods: {
      ...
      fd.append("data", `Insert into sekolah_data_siswa (id_kelas,id_jurusan,nama_siswa,nis,nisn,kota,t_lahir,t_masuk,kelamin,agama,status,anakke,alamat_siswa,telpon_siswa,sekolahasal,kelas,ayah,ibu,alamatortu,hportu,pekerjaanayah,pekerjaanibu,wali,alamatwali,hpwali,pekerjaanwali) VALUES ('${this.vdata.id_kelas}','${this.vdata.id_jurusan}','${this.vdata.nama_siswa}','${this.vdata.nis}','${this.vdata.nisn}','${this.vdata.kota}','${this.vdata.t_lahir}','${this.vdata.t_masuk}','${this.vdata.kelamin}','${this.vdata.agama}','${this.vdata.status}','${this.vdata.anakke}','${this.vdata.alamat_siswa}','${this.vdata.telpon_siswa}','${this.vdata.sekolahasal}','${this.vdata.kelas}','${this.vdata.ayah}','${this.vdata.ibu}','${this.vdata.alamatortu}','${this.vdata.hportu}','${this.vdata.pekerjaanayah}','${this.vdata.pekerjaanibu}','${this.vdata.wali}','${this.vdata.alamatwali}','${this.vdata.hpwali}','${this.vdata.pekerjaanwali}')`);
      ...
      fd.append("data", `UPDATE sekolah_data_siswa SET id_kelas='${this.vdata.id_kelas}',id_jurusan='${this.vdata.id_jurusan}',nama_siswa='${this.vdata.nama_siswa}',nis='${this.vdata.nis}',nisn='${this.vdata.nisn}',kota='${this.vdata.kota}',t_lahir='${this.vdata.t_lahir}',t_masuk='${this.vdata.t_masuk}',kelamin='${this.vdata.kelamin}',agama='${this.vdata.agama}',status='${this.vdata.status}',anakke='${this.vdata.anakke}',alamat_siswa='${this.vdata.alamat_siswa}',telpon_siswa='${this.vdata.telpon_siswa}',sekolahasal='${this.vdata.sekolahasal}',kelas='${this.vdata.kelas}',ayah='${this.vdata.ayah}',ibu='${this.vdata.ibu}',alamatortu='${this.vdata.alamatortu}',hportu='${this.vdata.hportu}',pekerjaanayah='${this.vdata.pekerjaanayah}',pekerjaanibu='${this.vdata.pekerjaanibu}',wali='${this.vdata.wali}',alamatwali='${this.vdata.alamatwali}',hpwali='${this.vdata.hpwali}',pekerjaanwali='${this.vdata.pekerjaanwali}' Where id_siswa = '${this.vdata.id_siswa}'`);
      fd.append("database", "infolay3_test");
      ...
      fd.append("data", `DELETE FROM sekolah_data_siswa WHERE  id_siswa =  '${this.vdata.id_siswa}'`);
      fd.append("database", "infolay3_test");
     ...
     refreshData() {
      ...
      fd2.append("data", `select tb1.id_siswa,tb2.nama_kelas,tb1.id_kelas,tb1.nama_siswa,tb1.nis,tb1.nisn,tb1.kota,tb1.t_lahir,tb1.t_masuk,tb1.kelamin,tb1.agama,tb1.status,tb1.anakke,tb1.alamat_siswa,tb1.telpon_siswa,tb1.sekolahasal,tb1.kelas,tb1.ayah,tb1.ibu,tb1.alamatortu,tb1.hportu,tb1.pekerjaanayah,tb1.pekerjaanibu,tb1.wali,tb1.alamatwali,tb1.hpwali,tb1.pekerjaanwali from sekolah_data_siswa tb1 left join setup_kelas tb2 on tb2.id_kelas=tb1.id_kelas where tb1.id_kelas='${this.$store.state.wali_kelas}'`); //if empty = *
  ...
  watch: {
    ...
    td() {
     ...
     let fd2 = new FormData()
      ...
      fd3.append('data', `select id_jurusan,nama_jurusan from setup_jurusan`)//database setting di server
