<template>
  <div class="font-times">
    <!-- FORM -->
      ...
      <p class="text-center text-uppercase pb-3">sekolah_jadwal</p>
    ...
    >
      <!-- FORM --> 
          ...
          <tr>
              ...
              <td style="width:90%;padding-bottom:5px;">
               <select class='form-control' required v-model="vdata.id_pelajaran">
                    <option v-for="(item, index) in pelajarans" :key="index+'siswas'" :value="item.id_pelajaran">{{item.nama_pelajaran}}</option>
                </select>
              </td>
            </tr>
          ...
          <tr>
              ...
              <td style="width:90%;padding-bottom:5px;">
                  <select class='form-control' required v-model="vdata.id_kelas">
                    <option v-for="(item, index) in kelas" :key="index+'siswas'" :value="item.id_kelas">{{item.nama_kelas}}</option>
                </select>
              </td>
            </tr>
             
          <tr>
              <td class='text-uppercase text-sm'>jam_masuk</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>hari</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
               <select class='form-control' v-model="vdata.hari">
                <option>Senin</option>
...
export default {
  ...
  data() {
    return {
      ...
      err: false,
      checkedItem:[],
      less: [,'_id','id_kelas','id_guru','id_pelajaran'],
      // modal
      modal: false,
      modalAction: "preview",
      // pagination
  ...
  methods: {
      ...
      fd.append("data", `Insert into sekolah_jadwal (id_pelajaran,id_guru,id_kelas,jam_masuk,hari,tanggal) VALUES ('${this.vdata.id_pelajaran}','${this.vdata.id_guru}','${this.vdata.id_kelas}','${this.vdata.jam_masuk}','${this.vdata.hari}','${new Date()}')`);
      ...
      fd.append("data", `UPDATE sekolah_jadwal SET id_pelajaran='${this.vdata.id_pelajaran}',id_guru='${this.vdata.id_guru}',id_kelas='${this.vdata.id_kelas}',jam_masuk='${this.vdata.jam_masuk}',hari='${this.vdata.hari}',tanggal='${this.vdata.tanggal}' Where id_jadwal = '${this.vdata.id_jadwal}'`);
      fd.append("database", "infolay3_test");
      ...
      fd.append("data", `DELETE FROM sekolah_jadwal WHERE  id_jadwal =  '${this.vdata.id_jadwal}'`);
      fd.append("database", "infolay3_test");
     ...
     refreshData() {
      ...
      fd2.append("data", "select tb1.id_jadwal,tb2.nama_pelajaran,tb1.id_pelajaran,tb3.nama_guru,tb1.id_guru,tb4.nama_kelas,tb1.id_kelas,tb1.jam_masuk,tb1.hari,tb1.tanggal from sekolah_jadwal tb1 left join setup_pelajaran tb2 on tb2.id_pelajaran=tb1.id_pelajaran left join sekolah_data_guru tb3 on tb3.id_guru=tb1.id_guru left join setup_kelas tb4 on tb4.id_kelas=tb1.id_kelas"); //if empty = *
      fd2.append('table', 'sekolah_jadwal')
