<template>
  <div class="font-times">
    <!-- FORM -->
      <p class="text-center text-uppercase">sekolah_data_siswa</p>
      <br>
    ...
    >
     ...
     <div class="row">
       ...
       <div class="col-4 text-center">
         <button
          type="submit"
          class="btn btn-sm btn-outline-primary ml-2 btn-block font-times text-uppercase"
...
export default {
  ...
  methods: {
      ...
      fd.append("data", `Insert into sekolah_data_siswa (nama_siswa,nis,nisn,kota,t_lahir,t_masuk,kelamin,agama,status,anakke,alamat_siswa,telpon_siswa,sekolahasal,kelas,ayah,ibu,alamatortu,hportu,pekerjaanayah,pekerjaanibu,wali,alamatwali,hpwali,pekerjaanwali) VALUES ('${this.vdata.nama_siswa}','${this.vdata.nis}','${this.vdata.nisn}','${this.vdata.kota}','${this.vdata.t_lahir}','${this.vdata.t_masuk}','${this.vdata.kelamin}','${this.vdata.agama}','${this.vdata.status}','${this.vdata.anakke}','${this.vdata.alamat_siswa}','${this.vdata.telpon_siswa}','${this.vdata.sekolahasal}','${this.vdata.kelas}','${this.vdata.ayah}','${this.vdata.ibu}','${this.vdata.alamatortu}','${this.vdata.hportu}','${this.vdata.pekerjaanayah}','${this.vdata.pekerjaanibu}','${this.vdata.wali}','${this.vdata.alamatwali}','${this.vdata.hpwali}','${this.vdata.pekerjaanwali}')`);
     ...
     refreshData() {
      ...
      fd2.append("data", "select id_siswa,nama_siswa,nis,nisn,kota,t_lahir,t_masuk,kelamin,agama,status,anakke,alamat_siswa,telpon_siswa,sekolahasal,kelas,ayah,ibu,alamatortu,hportu,pekerjaanayah,pekerjaanibu,wali,alamatwali,hpwali,pekerjaanwali from sekolah_data_siswa"); //if empty = *
