<template>
  <div class="font-times">
    <!-- FORM -->
      <p class="text-center text-uppercase">Raport Siswa</p>
       <div class="container-fluid" v-if="pilih.name!='taufik'">
          <div class="row ">
              <div class="col-sm-6 cursor-pointer animated fadeInDown" @click="$router.push(`/sekolah/guru/raport?id_siswa=${pilih.id_siswa}`)">
...
export default {
  ...
  methods: {
     ...
     refreshData() {
      ...
      fd2.append("data", "select tb1.id_siswa,tb2.nama_kelas,tb1.id_kelas,tb1.nama_siswa,tb1.nis,tb1.nisn,tb1.kota,tb1.t_lahir,tb1.t_masuk,tb1.kelamin,tb1.agama,tb1.status,tb1.anakke,tb1.alamat_siswa,tb1.telpon_siswa,tb1.sekolahasal,tb1.kelas,tb1.ayah,tb1.ibu,tb1.alamatortu,tb1.hportu,tb1.pekerjaanayah,tb1.pekerjaanibu,tb1.wali,tb1.alamatwali,tb1.hpwali,tb1.pekerjaanwali from sekolah_data_siswa tb1 left join setup_kelas tb2 on tb2.id_kelas=tb1.id_kelas"); //if empty = *
