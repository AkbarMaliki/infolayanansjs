<template>
  <div class="font-times">
    <!-- FORM -->
      ...
      <p class="text-center text-uppercase pb-3">setup_jurusan</p>
    ...
    >
      <!-- FORM --> 
          <tr>
              <td class='text-uppercase text-sm'>id_jurusan_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="id_jurusan_"
                    id="id_jurusan"
                    name="id_jurusan"
                    class="form-control form-control-sm"
                    v-model="vdata.id_jurusan"
                     disabled
                  >
                </div>
              </td>
          ...
          <tr>
              <td class='text-uppercase text-sm'>nama_jurusan_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="nama_jurusan_"
                    id="nama_jurusan"
                    name="nama_jurusan"
                    class="form-control form-control-sm"
                    v-model="vdata.nama_jurusan"
...
export default {
  ...
  methods: {
      ...
      fd.append("data", `Insert into setup_jurusan (nama_jurusan) VALUES ('${this.vdata.nama_jurusan}')`);
      fd.append("database", "infolay3_db_akademikk");
      ...
      fd.append("data", `UPDATE setup_jurusan SET nama_jurusan='${this.vdata.nama_jurusan}' Where id_jurusan = '${this.vdata.id_jurusan}'`);
      fd.append("database", "infolay3_db_akademikk");
      ...
      fd.append("data", `DELETE FROM setup_jurusan WHERE  id_jurusan =  '${this.vdata.id_jurusan}'`);
      fd.append("database", "infolay3_db_akademikk");
     ...
     refreshData() {
      ...
      fd2.append("data", "select id_jurusan,nama_jurusan from setup_jurusan"); //if empty = *
      fd2.append('table', 'setup_jurusan')
      fd2.append('database', "infolay3_db_akademikk")
