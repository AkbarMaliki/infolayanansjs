<template>
  <div class="font-times">
    <!-- FORM -->
      <p class="text-center text-uppercase pb-3">sekolah_data_guru</p>
    ...
    >
      ...
      <div class="container">
          ...
          <tr>
              <td class='text-uppercase text-sm'>nama_guru</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    ...
                    name="nama_guru"
                    class="form-control form-control-sm"
                    required v-model="vdata.nama_guru"
          ...
          <tr>
              <td class='text-uppercase text-sm'>nip</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
             ...
             <tr>
              <td class='text-uppercase text-sm'>username</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
              ...
              <tr>
              <td class='text-uppercase text-sm'>password</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>alamat_guru</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="alamat_guru"
                    id="alamat_guru"
                    name="alamat_guru"
                    class="form-control form-control-sm"
                    required v-model="vdata.alamat_guru"
          ...
          <tr>
              <td class='text-uppercase text-sm'>tm_tanggal</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="tm_tanggal"
                    id="tm_tanggal"
                    name="tm_tanggal"
                    class="form-control form-control-sm"
                     v-model="vdata.tm_tanggal"
          ...
          <tr>
              <td class='text-uppercase text-sm'>tm_bulan</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="tm_bulan"
                    id="tm_bulan"
                    name="tm_bulan"
                    class="form-control form-control-sm"
                     v-model="vdata.tm_bulan"
          ...
          <tr>
              <td class='text-uppercase text-sm'>tm_tahun</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="tm_tahun"
                    id="tm_tahun"
                    name="tm_tahun"
                    class="form-control form-control-sm"
                     v-model="vdata.tm_tahun"
          ...
          <tr>
              <td class='text-uppercase text-sm'>pendidikan</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                 <select class="form-control" required v-model="vdata.pendidikan">
          ...
          <tr>
              <td class='text-uppercase text-sm'>golongan</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    ...
                    name="golongan"
                    class="form-control form-control-sm"
                    required v-model="vdata.golongan"
          ...
          <tr>
              <td class='text-uppercase text-sm'>jabatan</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    ...
                    name="jabatan"
                    class="form-control form-control-sm"
                    required v-model="vdata.jabatan"
             ...
             <tr>
              <td class='text-uppercase text-sm'>pilih</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <select class='form-control' required v-model="vdata.pilih">
                  <option>guru</option>
                  <option>admin</option>
                </select>
              </td>
      ...
      ><span class="typcn typcn-edit"></span>{{aksi == 'insert' ? 'insert' : aksi == 'update' ? 'update' : 'remove'}}
      </button>
      </div>
      <!-- SUBMIT -->
    </form>
...
export default {
  ...
  methods: {
      ...
      fd.append("data", `Insert into sekolah_data_guru (username,password,nama_guru,nip,kota,tgl,bln,thn,kelamin,agama,alamat_guru,tm_tanggal,tm_bulan,tm_tahun,pendidikan,golongan,jabatan,gambar,pilih) VALUES ('${this.vdata.username}','${md5(this.vdata.password)}','${this.vdata.nama_guru}','${this.vdata.nip}','${this.vdata.kota}','${this.vdata.tgl}','${this.vdata.bln}','${this.vdata.thn}','${this.vdata.kelamin}','${this.vdata.agama}','${this.vdata.alamat_guru}','${this.vdata.tm_tanggal}','${this.vdata.tm_bulan}','${this.vdata.tm_tahun}','${this.vdata.pendidikan}','${this.vdata.golongan}','${this.vdata.jabatan}',' ','${this.vdata.pilih}')`);
      ...
      fd.append("data", `UPDATE sekolah_data_guru SET nama_guru='${this.vdata.nama_guru}',nip='${this.vdata.nip}',kota='${this.vdata.kota}',tgl='${this.vdata.tgl}',bln='${this.vdata.bln}',thn='${this.vdata.thn}',kelamin='${this.vdata.kelamin}',agama='${this.vdata.agama}',alamat_guru='${this.vdata.alamat_guru}',tm_tanggal='${this.vdata.tm_tanggal}',tm_bulan='${this.vdata.tm_bulan}',tm_tahun='${this.vdata.tm_tahun}',pendidikan='${this.vdata.pendidikan}',golongan='${this.vdata.golongan}',jabatan='${this.vdata.jabatan}',pilih='${this.vdata.pilih}' Where id_guru = '${this.vdata.id_guru}'`);
      fd.append("database", "infolay3_test");
      ...
      fd.append("data", `DELETE FROM sekolah_data_guru WHERE  id_guru =  '${this.vdata.id_guru}'`);
      fd.append("database", "infolay3_test");
     ...
     refreshData() {
      ...
      fd2.append("data", "select id_guru,nama_guru,nip,kota,kelamin,agama,alamat_guru,tm_tanggal,tm_bulan,tm_tahun,pendidikan,golongan,jabatan,pilih from sekolah_data_guru"); //if empty = *
      fd2.append('table', 'sekolah_data_guru')
