<template>
  <div class="font-times">
    <!-- FORM -->
      ...
      <p class="text-center text-uppercase pb-3">List Kelas</p>
    ...
    >
      <!-- FORM --> 
          ...
          <tr>
              <td class='text-uppercase text-sm'>id_wali</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <select class='form-contr required ol' v-model="vdata.id_wali">
          ...
          <tr>
              <td class='text-uppercase text-sm'>nama_kelas</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    ...
                    name="nama_kelas"
                    class="form-control form-control-sm"
                     required v-model="vdata.nama_kelas"
          ...
          <tr>
              <td class='text-uppercase text-sm'>jurusan</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    ...
                    name="jurusan"
                    class="form-control form-control-sm"
                     required v-model="vdata.jurusan"
        ...
        <div class="w-full sm:w-1/3">
          <div class="row">
            <div class="col-sm-3 order-2">
              <a :href="`https://infolayanans.space/api/mysql/sekolah/excel.php?data=select id_kelas,id_wali,nama_kelas,jurusan from setup_kelas&database=infolay3_test`" class="btn-lg btn-success" ><span class="typcn typcn-chart-bar"></span></a>
            </div>
...
export default {
  ...
  methods: {
      ...
      fd.append("data", `Insert into setup_kelas (id_wali,nama_kelas,jurusan) VALUES ('${this.vdata.id_wali}','${this.vdata.nama_kelas}','${this.vdata.jurusan}')`);
      ...
      fd.append("data", `UPDATE setup_kelas SET id_wali='${this.vdata.id_wali}',nama_kelas='${this.vdata.nama_kelas}',jurusan='${this.vdata.jurusan}' Where id_kelas = '${this.vdata.id_kelas}'`);
      fd.append("database", "infolay3_test");
      ...
      fd.append("data", `DELETE FROM setup_kelas WHERE  id_kelas =  '${this.vdata.id_kelas}'`);
      fd.append("database", "infolay3_test");
     ...
     refreshData() {
      ...
      fd2.append("data", "select id_kelas,id_wali,nama_kelas,jurusan from setup_kelas"); //if empty = *
      fd2.append('table', 'setup_kelas')
