<template>
  <div class="font-times">
    <!-- FORM -->
      <p class="text-center text-uppercase pb-3">setup_pelajaran</p>
    ...
    >
      <!-- FORM --> 
          <tr>
              ...
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="id_pelajaran"
                    id="id_pelajaran"
                    name="id_pelajaran"
                    class="form-control form-control-sm"
                    v-model="vdata.id_pelajaran"
                  disabled
          ...
          <tr>
              <td class='text-uppercase text-sm'>nama_pelajaran</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="nama_pelajaran"
                    id="nama_pelajaran"
                    name="nama_pelajaran"
                    class="form-control form-control-sm"
                    required v-model="vdata.nama_pelajaran"
        ...
        <div class="w-full sm:w-1/3">
          <div class="row">
            <div class="col-sm-3 order-2">
              <a :href="`https://infolayanans.space/api/mysql/sekolah/excel.php?data=select id_pelajaran,nama_pelajaran,kkm from setup_pelajaran&database=infolay3_test`" class="btn-lg btn-success" ><span class="typcn typcn-chart-bar"></span></a>
            </div>
...
export default {
  ...
  methods: {
      ...
      fd.append("data", `Insert into setup_pelajaran (nama_pelajaran,kkm) VALUES ('${this.vdata.nama_pelajaran}','${this.vdata.kkm}')`);
      ...
      fd.append("data", `UPDATE setup_pelajaran SET nama_pelajaran='${this.vdata.nama_pelajaran}',kkm='${this.vdata.kkm}' Where id_pelajaran = '${this.vdata.id_pelajaran}'`);
      fd.append("database", "infolay3_test");
      ...
      fd.append("data", `DELETE FROM setup_pelajaran WHERE  id_pelajaran =  '${this.vdata.id_pelajaran}'`);
      fd.append("database", "infolay3_test");
     ...
     refreshData() {
      ...
      fd2.append("data", "select id_pelajaran,nama_pelajaran,kkm from setup_pelajaran"); //if empty = *
      fd2.append('table', 'setup_pelajaran')
