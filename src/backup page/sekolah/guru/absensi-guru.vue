<template>
  <div class="font-times">
    <!-- FORM -->
      <p class="text-center text-uppercase pb-3">sekolah_absensi_guru</p>
    ...
    >
      <!-- FORM --> 
          ...
          <tr>
              ...
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                  <select class='form-control' v-model="vdata.id_guru" required>
          ...
          <tr>
              ...
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <select class='form-control' v-model="vdata.id_pelajaran" required>
                    <option v-for="(item, index) in pelajarans" :key="index+'gurus'" :value="item.id_pelajaran">{{item.nama_pelajaran}}</option>
                  </select>
              </td>
            </tr>
          ...
          <tr>
              ...
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <select class='form-control' v-model="vdata.id_kelas" required>
...
export default {
  ...
  data() {
    return {
      ...
      err: false,
      checkedItem:[],
      less: [,'_id','id_guru','id_kelas','id_pelajaran'],
      // modal
      modal: false,
      modalAction: "preview",
      // pagination
  ...
  methods: {
      ...
      fd.append("data", `Insert into sekolah_absensi_guru (id_guru,id_pelajaran,id_kelas,tanggal,hadir) VALUES ('${this.vdata.id_guru}','${this.vdata.id_pelajaran}','${this.vdata.id_kelas}','${this.vdata.tanggal}','${this.vdata.hadir}')`);
      ...
      fd.append("data", `UPDATE sekolah_absensi_guru SET id_guru='${this.vdata.id_guru}',id_pelajaran='${this.vdata.id_pelajaran}',id_kelas='${this.vdata.id_kelas}',tanggal='${this.vdata.tanggal}',hadir='${this.vdata.hadir}' Where id = '${this.vdata.id}'`);
      fd.append("database", "infolay3_test");
      ...
      fd.append("data", `DELETE FROM sekolah_absensi_guru WHERE  id =  '${this.vdata.id}'`);
      fd.append("database", "infolay3_test");
     ...
     refreshData() {
      ...
      fd2.append("data", "select tb1.id,tb1.id_guru,tb2.nama_guru,tb1.id_pelajaran,tb3.nama_pelajaran,tb1.id_kelas,tb4.nama_kelas,tb1.tanggal,tb1.hadir from sekolah_absensi_guru tb1 left join sekolah_data_guru tb2 on tb2.id_guru=tb1.id_guru left join setup_pelajaran tb3 on tb3.id_pelajaran=tb1.id_pelajaran left join setup_kelas tb4 on tb4.id_kelas=tb1.id_kelas"); //if empty = *
      fd2.append('table', 'sekolah_absensi_guru')
