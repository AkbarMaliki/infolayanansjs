...
export default {
  ...
  data() {
    return {
      ...
      err: false,
      checkedItem:[],
      less: [,'_id','id_guru','id_kelas','id_pelajaran','file','tanggal_awal'],
      // modal
      modal: false,
      modalAction: "preview",
      // pagination
