<template>
  <div class="font-times">
    <!-- FORM -->
      <p class="text-center text-uppercase pb-3">sekolah_nilai</p>
    ...
    >
      ...
      <div class="row">
          <div class="col-6">
                <tr>
              <td class='text-uppercase text-sm'>id_nilai</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="id_nilai"
                    id="id_nilai"
                    name="id_nilai"
                    class="form-control form-control-sm"
                    v-model="vdata.id_nilai"
                  disabled
          ...
          <tr>
              ...
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <select class='form-control' required v-model="vdata.id_siswa">
                    <option v-for="(item, index) in siswas" :key="index+'siswas'" :value="item.id_siswa">{{item.nama_siswa}}</option>
                </select>
              </td>
            </tr>
             
          <tr class="d-none">
              <td class='text-uppercase text-sm'>id_jadwal</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="id_jadwal"
                    id="id_jadwal"
                    name="id_jadwal"
                    class="form-control form-control-sm"
                    v-model="vdata.id_jadwal"
          ...
          <tr>
              ...
              <td style="width:90%;padding-bottom:5px;">
                  <select class='form-control' required v-model="vdata.id_kelas">
                    <option v-for="(item, index) in kelas" :key="index+'kelas'" :value="item.id_kelas">{{item.nama_kelas}}</option>
                </select>
              </td>
            </tr>
          ...
          <tr>
              ...
              <td style="width:90%;padding-bottom:5px;">
                  <select class='form-control' required v-model="vdata.id_guru">
                    <option v-for="(item, index) in gurus" :key="index+'siswas'" :value="item.id_guru">{{item.nama_guru}}</option>
                </select>
              </td>
            </tr>
            <tr>
              <td class='text-uppercase text-sm'>id_pelajaran</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                  <select class='form-control' required v-model="vdata.id_pelajaran">
                    <option v-for="(item, index) in pelajarans" :key="index+'pelajarans'" :value="item.id_pelajaran">{{item.nama_pelajaran}}</option>
                </select>
              </td>
            </tr>
          <tr>
              <td class='text-uppercase text-sm'>nilai_uh1</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="nilai_uh1"
                    id="nilai_uh1"
                    name="nilai_uh1"
                    class="form-control form-control-sm"
                    v-model="vdata.nilai_uh1"
          ...
          <tr>
              <td class='text-uppercase text-sm'>nilai_uh2</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="nilai_uh2"
                    id="nilai_uh2"
                    name="nilai_uh2"
                    class="form-control form-control-sm"
                    v-model="vdata.nilai_uh2"
          ...
          <tr>
              <td class='text-uppercase text-sm'>nilai_uh3</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="nilai_uh3"
                    id="nilai_uh3"
                    name="nilai_uh3"
                    class="form-control form-control-sm"
                    v-model="vdata.nilai_uh3"
          ...
          <tr>
              <td class='text-uppercase text-sm'>nilai_uh4</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="nilai_uh4"
                    id="nilai_uh4"
                    name="nilai_uh4"
                    class="form-control form-control-sm"
                    v-model="vdata.nilai_uh4"
          ...
          <tr>
              <td class='text-uppercase text-sm'>nilai_uh5</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="nilai_uh5"
                    id="nilai_uh5"
                    name="nilai_uh5"
                    class="form-control form-control-sm"
                    v-model="vdata.nilai_uh5"
          ...
          <tr>
              <td class='text-uppercase text-sm'>rata_uh</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>nilai_tugas1</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="nilai_tugas1"
                    id="nilai_tugas1"
                    name="nilai_tugas1"
                    class="form-control form-control-sm"
                    v-model="vdata.nilai_tugas1"
          ...
          <tr>
              <td class='text-uppercase text-sm'>nilai_tugas2</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="nilai_tugas2"
                    id="nilai_tugas2"
                    name="nilai_tugas2"
                    class="form-control form-control-sm"
                    v-model="vdata.nilai_tugas2"
          ...
          <tr>
              <td class='text-uppercase text-sm'>nilai_tugas3</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="nilai_tugas3"
                    id="nilai_tugas3"
                    name="nilai_tugas3"
                    class="form-control form-control-sm"
                    v-model="vdata.nilai_tugas3"
          ...
          <tr>
              <td class='text-uppercase text-sm'>nilai_tugas4</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="nilai_tugas4"
                    id="nilai_tugas4"
                    name="nilai_tugas4"
                    class="form-control form-control-sm"
                    v-model="vdata.nilai_tugas4"
          ...
          <tr>
              <td class='text-uppercase text-sm'>rata_tugas</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="rata_tugas"
                    id="rata_tugas"
                    name="rata_tugas"
                    class="form-control form-control-sm"
                    v-model="vdata.rata_tugas"
          ...
          <tr>
              <td class='text-uppercase text-sm'>nilai_harian</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="nilai_harian"
                    id="nilai_harian"
                    name="nilai_harian"
                    class="form-control form-control-sm"
                    v-model="vdata.nilai_harian"
              ...
              <tr>
              <td class='text-uppercase text-sm'>nilai_uts</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="nilai_uts"
                    id="nilai_uts"
                    name="nilai_uts"
                    class="form-control form-control-sm"
                    v-model="vdata.nilai_uts"
          ...
          <tr>
              <td class='text-uppercase text-sm'>nilai_uas</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="nilai_uas"
                    id="nilai_uas"
                    name="nilai_uas"
                    class="form-control form-control-sm"
                    v-model="vdata.nilai_uas"
          ...
          <tr>
              <td class='text-uppercase text-sm'>nilai_rapor</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="nilai_rapor"
                    id="nilai_rapor"
                    name="nilai_rapor"
                    class="form-control form-control-sm"
                    v-model="vdata.nilai_rapor"
          ...
          <tr>
              <td class='text-uppercase text-sm'>kkm</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>ket</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
...
export default {
  ...
  data() {
    return {
      ...
      err: false,
      checkedItem:[],
      less: [,'_id','id_kelas','id_siswa','id_guru','id_pelajaran'],
      // modal
      modal: false,
      modalAction: "preview",
      // pagination
  ...
  methods: {
      ...
      fd.append("data", `Insert into sekolah_nilai (id_siswa,id_pelajaran,id_jadwal,id_kelas,id_guru,nilai_uh1,nilai_uh2,nilai_uh3,nilai_uh4,nilai_uh5,rata_uh,nilai_tugas1,nilai_tugas2,nilai_tugas3,nilai_tugas4,rata_tugas,nilai_harian,nilai_uas,nilai_rapor,kkm,ket,nilai_uts) VALUES ('${this.vdata.id_siswa}','${this.vdata.id_pelajaran}','${this.vdata.id_jadwal}','${this.vdata.id_kelas}','${this.vdata.id_guru}','${this.vdata.nilai_uh1}','${this.vdata.nilai_uh2}','${this.vdata.nilai_uh3}','${this.vdata.nilai_uh4}','${this.vdata.nilai_uh5}','${this.vdata.rata_uh}','${this.vdata.nilai_tugas1}','${this.vdata.nilai_tugas2}','${this.vdata.nilai_tugas3}','${this.vdata.nilai_tugas4}','${this.vdata.rata_tugas}','${this.vdata.nilai_harian}','${this.vdata.nilai_uas}','${this.vdata.nilai_rapor}','${this.vdata.kkm}','${this.vdata.ket}','${this.vdata.nilai_uts}')`);
      ...
      fd.append("data", `UPDATE sekolah_nilai SET id_siswa='${this.vdata.id_siswa}',id_pelajaran='${this.vdata.id_pelajaran}',nilai_uts='${this.vdata.nilai_uts}',id_jadwal='${this.vdata.id_jadwal}',id_kelas='${this.vdata.id_kelas}',id_guru='${this.vdata.id_guru}',nilai_uh1='${this.vdata.nilai_uh1}',nilai_uh2='${this.vdata.nilai_uh2}',nilai_uh3='${this.vdata.nilai_uh3}',nilai_uh4='${this.vdata.nilai_uh4}',nilai_uh5='${this.vdata.nilai_uh5}',rata_uh='${this.vdata.rata_uh}',nilai_tugas1='${this.vdata.nilai_tugas1}',nilai_tugas2='${this.vdata.nilai_tugas2}',nilai_tugas3='${this.vdata.nilai_tugas3}',nilai_tugas4='${this.vdata.nilai_tugas4}',rata_tugas='${this.vdata.rata_tugas}',nilai_harian='${this.vdata.nilai_harian}',nilai_uas='${this.vdata.nilai_uas}',nilai_rapor='${this.vdata.nilai_rapor}',kkm='${this.vdata.kkm}',ket='${this.vdata.ket}' Where id_nilai = '${this.vdata.id_nilai}'`);
      fd.append("database", "infolay3_test");
      ...
      fd.append("data", `DELETE FROM sekolah_nilai WHERE  id_nilai =  '${this.vdata.id_nilai}'`);
      fd.append("database", "infolay3_test");
     ...
     refreshData() {
      ...
      fd2.append("data", "select tb1.id_nilai,tb2.nama_siswa,tb1.id_siswa,tb4.nama_kelas,tb1.id_kelas,tb3.nama_guru,tb1.id_guru,tb5.nama_pelajaran,tb1.id_pelajaran,tb1.nilai_uh1,tb1.nilai_uh2,tb1.nilai_uh3,tb1.nilai_uh4,tb1.nilai_uh5,tb1.rata_uh,tb1.nilai_tugas1,tb1.nilai_tugas2,tb1.nilai_tugas3,tb1.nilai_tugas4,tb1.rata_tugas,tb1.nilai_harian,tb1.nilai_uts,tb1.nilai_uas,tb1.nilai_rapor,tb1.kkm,tb1.ket from sekolah_nilai tb1 left join sekolah_data_siswa tb2 on tb2.id_siswa=tb1.id_siswa left join sekolah_data_guru tb3 on tb3.id_guru=tb1.id_guru left join setup_kelas tb4 on tb4.id_kelas=tb1.id_kelas left join setup_pelajaran tb5 on tb5.id_pelajaran=tb1.id_pelajaran"); //if empty = *
      fd2.append('table', 'sekolah_nilai')
  ...
  watch: {
    ...
    td() {
      ...
      , {
       ...
       let fdss = new FormData()
      fdss.append('data', `select id_pelajaran,nama_pelajaran from setup_pelajaran`)//database setting di server
      fdss.append('database','infolay3_test')
      axios.post('https://infolayanans.space/api/mysql/auto.php', fdss
      , {
          headers: {
          Authorization: localStorage.getItem('auth._token.local')
          }
      ...
      fd3.append('data', `select id_pelajaran,nama_pelajaran from setup_pelajaran`)//database setting di server
      ...
      fd4.append('data', `select id_siswa,nama_siswa from sekolah_data_siswa`)//database setting di server
