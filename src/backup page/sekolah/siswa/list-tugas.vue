      ...
      <div class="row">
        <div class="offset-sm-2 col-sm-8">
          <tr>
            <td>Nama Guru</td>
            <td>&nbsp;:&nbsp;</td>
            <td>{{pilih.nama_guru}}</td>
          </tr>
            <tr>
            <td>Nama Pelajaran</td>
            <td>&nbsp;:&nbsp;</td>
            <td>{{pilih.nama_pelajaran}}</td>
          </tr>
            <tr>
            <td>Kelas</td>
            <td>&nbsp;:&nbsp;</td>
            <td>{{pilih.nama_kelas}}</td>
          </tr>
            <tr>
            <td>Keterangan</td>
            <td>&nbsp;:&nbsp;</td>
          ...
          <tr>
            <td>File</td>
            <td>&nbsp;:&nbsp;</td>
            <td><a :href="`https://infolayanans.space/${pilih.file}`">https://infolayanans.space/{{pilih.file}}</a> </td>
          </tr>
          <tr>
            <td>tanggal_akhir</td>
            <td>&nbsp;:&nbsp;</td>
            <td>{{pilih.tanggal_akhir ?  format(pilih.tanggal_akhir) : ""}} | {{pilih.tanggal_akhir ? distanceToNow(pilih.tanggal_akhir) : ""}} 
              <span class="text-green" v-if="pilih.tanggal_akhir ? isFuture(pilih.tanggal_akhir) : ''"> Akan Datang</span>
              <span class="text-red" v-else>Yang Lalu</span>
  ...
  methods: {
    ...
    axios
     ...
     refreshData() {
      ...
      fd2.append("data", `select tb1.id_tugas,tb2.nama_guru,tb1.id_guru,tb3.nama_pelajaran,tb1.id_pelajaran,tb4.nama_kelas,tb1.id_kelas,tb1.ket,tb1.file,tb1.tanggal_awal,tb1.tanggal_akhir from sekolah_tugas tb1 left join sekolah_data_guru tb2 on tb2.id_guru=tb1.id_guru left join setup_pelajaran tb3 on tb3.id_pelajaran=tb1.id_pelajaran left join setup_kelas tb4 on tb4.id_kelas=tb1.id_kelas where tb1.id_kelas='${this.$store.state.users.id_kelas}' order by tb1.tanggal_akhir desc`); //if empty = *
