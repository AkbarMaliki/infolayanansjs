<template>
  <div class="bg-white">
    <!-- FORM -->
      ...
      <div class="row  ml-2 mr-2 bg-white rounded-lg p-3 pt-4  shadow-outline" style="margin-top:-80px;">
    ...
    >
      <!-- FORM --> 
          ...
          <tr>
              <td class='text-uppercase text-sm'>Nama Mobil</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>No Plate</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>Warna</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>Keterangan</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                 <div class="sm-form">
                    <textarea type="text" id="Keterangan" name="Keterangan" rows="2" placeholder="isi" class="form-control md-textarea" v-model="vdata.keterangan">{{vdata.keterangan}}</textarea>
                </div>
              </td>
            </tr>
             <tr>
   ...
   <img :src="vdata.gambar" class="kinoLightBox img-fluid " style="height:200px;" alt="">
   {{this.file}}
   </div>
   <br>
            <!-- FORM -->
      ...
      <button
        type="submit"
        class="btn btn-sm btn-outline-primary ml-2 btn-block font-times text-uppercase text-sm"
     ...
     <hr class="style13" />
     <div class="row">
       <div class="col-4"> <button type="button" @click="aksi='insert';clearInput()" class="btn btn-sm btn-success btn-block font-times text-capitalize text-sm">insert</button></div>
       <div class="col-4"><button type="button" @click="aksi='update'" class="btn btn-sm btn-warning btn-block font-times text-capitalize text-sm">update</button></div>
       <div class="col-4"><button type="button" @click="aksi='remove'" class="btn btn-sm btn-danger btn-block font-times text-capitalize text-sm">remove</button></div>
     </div>
      </div>
      </div>
      <br>
  ...
  methods: {
   compress(event) {
    ...
    inputfile () {
      ...
      fd.append("data", `Insert into driver_mobil (nama_mobil,no_plate,warna,gambar,status,keterangan) VALUES ('${this.vdata.nama_mobil}','${this.vdata.no_plate}','${this.vdata.warna}','${this.file}','${this.vdata.status}','${this.vdata.keterangan}')`);
      fd.append("database", " infolay3_test");
      ...
      fd.append("data", `UPDATE driver_mobil SET nama_mobil='${this.vdata.nama_mobil}',no_plate='${this.vdata.no_plate}',warna='${this.vdata.warna}',gambar='${this.file}',status='${this.vdata.status}',keterangan='${this.vdata.keterangan}' Where id = '${this.vdata.id}'`);
      fd.append("database", " infolay3_test");
      ...
      fd.append("data", `DELETE FROM driver_mobil WHERE  id =  '${this.vdata.id}'`);
      fd.append("database", " infolay3_test");
     ...
     refreshData() {
      ...
      fd2.append("data", "select * from driver_mobil"); //if empty = *
      fd2.append('table', 'driver_mobil')
