    ...
    updates(){
     console.log(this.infos.id)
      if (confirm("Yakin route di update ? ")) {
        let fd = new FormData()
        fd.append('data', `insert into driver_route (id_perjalanan,route,update_route) VALUES ('${this.infos.id}','${this.routerbaru}','${this.jam}')`)
