  ...
  <div>
         <div class="bg-white" style="height:100vh;">
            ...
            <div class="bg-white p-2 mt-2 rounded-lg shadow-inner " style="margin-top:-50px;">
              <p class="text-center font-bold font-times text-uppercase">MOBIL {{datanya[0].nama}}</p>
...
export default {
  ...
  mounted() {
      let fd = new FormData()
      fd.append('data', `select tb1.nama_mobil as nama,tb2.tanggal from driver_mobil tb1 left join driver_perjalanan tb2 on tb2.id_mobil=tb1.id where tb1.id='${this.$route.query.id}'`)
