...
export default {
  ...
  data() {
   ...
   mounted() {
       ...
       fds.append('data', `select nama from tbuser where posisi="DRIVER"`)
       ...
       , {
           ...
           this.$forceUpdate()
            let fd = new FormData()
            fd.append('data', `select tb1.nama,tb2.tanggal from tbuser tb1 left join driver_perjalanan tb2 on tb2.id_driver=tb1.id where tb1.posisi="DRIVER"`)
