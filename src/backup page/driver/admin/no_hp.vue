<template>
  <div class="font-times">
    <!-- FORM -->
      ...
      <p class="text-center text-uppercase pb-3">tbuser_nohp</p>
    ...
    >
      <!-- FORM --> 
          ...
          <tr>
              <td class='text-uppercase text-sm'>ga_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>dbm_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>dsm_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
        ...
        <div class="w-full sm:w-1/3">
          <div class="row">
            <div class="col-sm-3 order-2">
              <a :href="`https://infolayanans.space/api/mysql/excel.php?data=select id,ga,dbm,dsm from tbuser_nohp&database=infolay3_test`" class="btn-lg btn-success" ><span class="typcn typcn-chart-bar"></span></a>
              <download-excel
                :data='td'>
...
export default {
  ...
  methods: {
      ...
      fd.append("data", `Insert into tbuser_nohp (ga,dbm,dsm) VALUES ('${this.vdata.ga}','${this.vdata.dbm}','${this.vdata.dsm}')`);
      ...
      fd.append("data", `UPDATE tbuser_nohp SET ga='${this.vdata.ga}',dbm='${this.vdata.dbm}',dsm='${this.vdata.dsm}' Where id = '${this.vdata.id}'`);
      fd.append("database", "infolay3_test");
      ...
      fd.append("data", `DELETE FROM tbuser_nohp WHERE  id =  '${this.vdata.id}'`);
      fd.append("database", "infolay3_test");
     ...
     refreshData() {
      ...
      fd2.append("data", "select id,ga,dbm,dsm from tbuser_nohp"); //if empty = *
      fd2.append('table', 'tbuser_nohp')
