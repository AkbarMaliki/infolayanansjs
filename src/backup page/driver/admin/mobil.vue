<template>
  <div class="font-times">
    <!-- FORM -->
      ...
      <p class="text-center text-uppercase pb-3">driver_mobil</p>
    ...
    >
      <!-- FORM --> 
          ...
          <tr>
              <td class='text-uppercase text-sm'>nama_mobil_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>no_plate_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="no_plate_"
                    id="no_plate"
                    name="no_plate"
                    class="form-control form-control-sm"
          ...
          <tr>
              <td class='text-uppercase text-sm'>warna_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
        ...
        <div class="w-full sm:w-1/3">
          <div class="row">
            <div class="col-sm-3 order-2">
              <a :href="`https://infolayanans.space/api/mysql/excel.php?data=select id,nama_mobil,no_plate,warna,gambar,status,keterangan from driver_mobil&database=infolay3_test`" class="btn-lg btn-success" ><span class="typcn typcn-chart-bar"></span></a>
              <download-excel
                :data='td'>
...
export default {
  ...
  methods: {
      ...
      fd.append("data", `Insert into driver_mobil (nama_mobil,no_plate,warna,gambar,status,keterangan) VALUES ('${this.vdata.nama_mobil}','${this.vdata.no_plate}','${this.vdata.warna}','${this.vdata.gambar}','${this.vdata.status}','${this.vdata.keterangan}')`);
      ...
      fd.append("data", `UPDATE driver_mobil SET nama_mobil='${this.vdata.nama_mobil}',no_plate='${this.vdata.no_plate}',warna='${this.vdata.warna}',gambar='${this.vdata.gambar}',status='${this.vdata.status}',keterangan='${this.vdata.keterangan}' Where id = '${this.vdata.id}'`);
      fd.append("database", "infolay3_test");
     ...
     refreshData() {
      ...
      fd2.append("data", "select id,nama_mobil,no_plate,warna,gambar,status,keterangan from driver_mobil"); //if empty = *
