<template>
  <div class="font-times">
    <!-- FORM -->
      ...
      <p class="text-center text-uppercase pb-3">tbuser</p>
    ...
    >
      <!-- FORM --> 
          ...
          <tr>
              <td class='text-uppercase text-sm'>username_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>password_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>no_hp_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>status_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>ket_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>email_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>profile_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="profile_"
                    id="profile"
                    name="profile"
                    class="form-control form-control-sm"
                    v-model="vdata.profile"
              required
          ...
          <tr>
              <td class='text-uppercase text-sm'>alamat_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>tglahir_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="tglahir_"
                    id="tglahir"
                    name="tglahir"
                    class="form-control form-control-sm"
          ...
          <tr>
              <td class='text-uppercase text-sm'>posisi_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>unit_kerja_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                  <select class='form-control' v-model="vdata.unit_kerja" @change="tess($event)">
                  <option v-for="(item, index) in units" :key="index+'units'" :value="item.id">{{item.nama_unit}}</option>
                </select>
              </td>
            </tr>
             
          <tr>
              <td class='text-uppercase text-sm'>unit_kerja_head_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="unit_kerja_head_"
                    id="unit_kerja_head"
                    name="unit_kerja_head"
                    class="form-control form-control-sm"
                    v-model="vdata.unit_kerja_head"
              required
          ...
          <tr>
              <td class='text-uppercase text-sm'>ganti_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>fcm_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
        ...
        <div class="w-full sm:w-1/3">
          <div class="row">
            <div class="col-sm-3 order-2">
              <a :href="`https://infolayanans.space/api/mysql/excel.php?data=select id,username,password,nip,nama,no_hp,status,ket,email,profile,alamat,tglahir,link,posisi,unit_kerja,unit_kerja_head,ganti,fcm from tbuser&database=infolay3_test`" class="btn-lg btn-success" ><span class="typcn typcn-chart-bar"></span></a>
              <download-excel
                :data='td'>
...
export default {
  ...
  methods: {
      ...
      fd.append("data", `Insert into tbuser (username,password,nip,nama,no_hp,status,ket,email,profile,alamat,tglahir,link,posisi,unit_kerja,unit_kerja_head,ganti,fcm) VALUES ('${this.vdata.username}','${this.vdata.password}','${this.vdata.nip}','${this.vdata.nama}','${this.vdata.no_hp}','${this.vdata.status}','${this.vdata.ket}','${this.vdata.email}','${this.vdata.profile}','${this.vdata.alamat}','${this.vdata.tglahir}','${this.vdata.link}','${this.vdata.posisi}','${this.vdata.unit_kerja}','${this.vdata.unit_kerja_head}','${this.vdata.ganti}','${this.vdata.fcm}')`);
      ...
      fd.append("data", `UPDATE tbuser SET username='${this.vdata.username}',password='${this.vdata.password}',nip='${this.vdata.nip}',nama='${this.vdata.nama}',no_hp='${this.vdata.no_hp}',status='${this.vdata.status}',ket='${this.vdata.ket}',email='${this.vdata.email}',profile='${this.vdata.profile}',alamat='${this.vdata.alamat}',tglahir='${this.vdata.tglahir}',link='${this.vdata.link}',posisi='${this.vdata.posisi}',unit_kerja='${this.vdata.unit_kerja}',unit_kerja_head='${this.vdata.unit_kerja_head}',ganti='${this.vdata.ganti}',fcm='${this.vdata.fcm}' Where id = '${this.vdata.id}'`);
      fd.append("database", "infolay3_test");
      ...
      fd.append("data", `DELETE FROM tbuser WHERE  id =  '${this.vdata.id}'`);
      fd.append("database", "infolay3_test");
     ...
     refreshData() {
      ...
      fd2.append("data", "select id,username,password,nip,nama,no_hp,status,ket,email,profile,alamat,tglahir,link,posisi,unit_kerja,unit_kerja_head,ganti,fcm from tbuser"); //if empty = *
