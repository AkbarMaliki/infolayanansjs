<template>
  <div class="font-times">
    <!-- FORM -->
      ...
      <p class="text-center text-uppercase pb-3">driver_unit</p>
    ...
    >
      <!-- FORM --> 
          ...
          <tr>
              <td class='text-uppercase text-sm'>nama_unit_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>kode_unit_head_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="kode_unit_head_"
                    id="kode_unit_head"
                    name="kode_unit_head"
                    class="form-control form-control-sm"
                    v-model="vdata.kode_unit_head"
          ...
          <tr>
              <td class='text-uppercase text-sm'>kode_unit_bawahan_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="kode_unit_bawahan_"
                    id="kode_unit_bawahan"
                    name="kode_unit_bawahan"
                    class="form-control form-control-sm"
                    v-model="vdata.kode_unit_bawahan"
...
export default {
  ...
  methods: {
      ...
      fd.append("data", `Insert into driver_unit (nama_unit,kode_unit_head,kode_unit_bawahan) VALUES ('${this.vdata.nama_unit}','${this.vdata.kode_unit_head}','${this.vdata.kode_unit_bawahan}')`);
      ...
      fd.append("data", `UPDATE driver_unit SET nama_unit='${this.vdata.nama_unit}',kode_unit_head='${this.vdata.kode_unit_head}',kode_unit_bawahan='${this.vdata.kode_unit_bawahan}' Where id = '${this.vdata.id}'`);
      fd.append("database", "infolay3_test");
      ...
      fd.append("data", `DELETE FROM driver_unit WHERE  id =  '${this.vdata.id}'`);
      fd.append("database", "infolay3_test");
     ...
     refreshData() {
      ...
      fd2.append("data", "select id,nama_unit,kode_unit_head,kode_unit_bawahan from driver_unit"); //if empty = *
      fd2.append('table', 'driver_unit')
