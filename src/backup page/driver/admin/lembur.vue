<template>
  <div class="font-times">
    <!-- FORM -->
      ...
      <p class="text-center text-uppercase pb-3">driver_lembur</p>
    ...
    >
      <!-- FORM --> 
          ...
          <tr>
              <td class='text-uppercase text-sm'>id_user_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="id_user_"
                    id="id_user"
                    name="id_user"
                    class="form-control form-control-sm"
                    v-model="vdata.id_user"
          ...
          <tr>
              <td class='text-uppercase text-sm'>jenis_pekerjaan_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="jenis_pekerjaan_"
                    id="jenis_pekerjaan"
          ...
          <tr>
              <td class='text-uppercase text-sm'>jam_lembur_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="jam_lembur_"
                    id="jam_lembur"
                    name="jam_lembur"
                    class="form-control form-control-sm"
                    v-model="vdata.jam_lembur"
          ...
          <tr>
              <td class='text-uppercase text-sm'>jam_lama_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="jam_lama_"
                    id="jam_lama"
                    name="jam_lama"
                    class="form-control form-control-sm"
                    v-model="vdata.jam_lama"
          ...
          <tr>
              <td class='text-uppercase text-sm'>tanggal_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="tanggal_"
                    id="tanggal"
                    name="tanggal"
                    class="form-control form-control-sm"
          ...
          <tr>
              <td class='text-uppercase text-sm'>ttd_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>unit_head_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="unit_head_"
                    id="unit_head"
                    name="unit_head"
                    class="form-control form-control-sm"
                    v-model="vdata.unit_head"
          ...
          <tr>
              <td class='text-uppercase text-sm'>head_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
        ...
        <div class="w-full sm:w-1/3">
          <div class="row">
            <div class="col-sm-3 order-2">
              <a :href="`https://infolayanans.space/api/mysql/excel.php?data=select id,id_user,jenis_pekerjaan,rincian_kerja,jam_lembur,jam_lama,tanggal,status,disposisi1,disposisi2,ttd,unit_head,head from driver_lembur&database=infolay3_test`" class="btn-lg btn-success" ><span class="typcn typcn-chart-bar"></span></a>
              <download-excel
                :data='td'>
...
export default {
  ...
  methods: {
      ...
      fd.append("data", `Insert into driver_lembur (id_user,jenis_pekerjaan,rincian_kerja,jam_lembur,jam_lama,tanggal,status,disposisi1,disposisi2,ttd,unit_head,head) VALUES ('${this.vdata.id_user}','${this.vdata.jenis_pekerjaan}','${this.vdata.rincian_kerja}','${this.vdata.jam_lembur}','${this.vdata.jam_lama}','${this.vdata.tanggal}','${this.vdata.status}','${this.vdata.disposisi1}','${this.vdata.disposisi2}','${this.vdata.ttd}','${this.vdata.unit_head}','${this.vdata.head}')`);
      ...
      fd.append("data", `UPDATE driver_lembur SET id_user='${this.vdata.id_user}',jenis_pekerjaan='${this.vdata.jenis_pekerjaan}',rincian_kerja='${this.vdata.rincian_kerja}',jam_lembur='${this.vdata.jam_lembur}',jam_lama='${this.vdata.jam_lama}',tanggal='${this.vdata.tanggal}',status='${this.vdata.status}',disposisi1='${this.vdata.disposisi1}',disposisi2='${this.vdata.disposisi2}',ttd='${this.vdata.ttd}',unit_head='${this.vdata.unit_head}',head='${this.vdata.head}' Where id = '${this.vdata.id}'`);
      fd.append("database", "infolay3_test");
      ...
      fd.append("data", `DELETE FROM driver_lembur WHERE  id =  '${this.vdata.id}'`);
      fd.append("database", "infolay3_test");
     ...
     refreshData() {
      ...
      fd2.append("data", "select id,id_user,jenis_pekerjaan,rincian_kerja,jam_lembur,jam_lama,tanggal,status,disposisi1,disposisi2,ttd,unit_head,head from driver_lembur"); //if empty = *
      fd2.append('table', 'driver_lembur')
