  ...
  <div class="font-times">
    ...
    >
      <!-- FORM --> 
          ...
          <tr>
              <td class='text-uppercase text-sm'>reset</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>posisi</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                  <select class='form-control' v-model="vdata.posisi">
                  <option>Admin</option>
                  <option>Head</option>
...
export default {
  ...
  methods: {
      ...
      fd.append("data", `Insert into sdd_tbuser (username,password,wilayah,technical_support,RO,reset,posisi) VALUES ('${this.vdata.username}','${this.vdata.password}','${this.vdata.wilayah}','${this.vdata.technical_support}','${this.vdata.RO}','${this.vdata.reset}','${this.vdata.posisi}')`);
      ...
      fd.append("data", `UPDATE sdd_tbuser SET username='${this.vdata.username}',password='${this.vdata.password}',wilayah='${this.vdata.wilayah}',technical_support='${this.vdata.technical_support}',RO='${this.vdata.RO}',reset='${this.vdata.reset}',posisi='${this.vdata.posisi}' Where id = '${this.vdata.id}'`);
      fd.append("database", "infolay3_test");
     ...
     refreshData() {
      ...
      fd2.append("data", "select id,username,password,wilayah,technical_support,RO,reset,posisi from sdd_tbuser"); //if empty = *
