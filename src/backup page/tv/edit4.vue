<template>
  <div>
    <!-- FORM -->
    <br />
    <p class="text-center text-uppercase">btn_tv_iklan</p>
    <br />
    <div class="row">
      <div class="offset-sm-2 col-sm-8">
        ...
        >
          <!-- FORM -->
          <tr>
            <td class="text-uppercase">id_</td>
            <td>&nbsp;:&nbsp;</td>
          ...
          <tr>
            <td class="text-uppercase">text_</td>
            <td>&nbsp;:&nbsp;</td>
            <td style="width:90%;padding-bottom:5px;">
              <div class="sm-form">
                <textarea
...
export default {
  ...
  methods: {
    insert () {
      ...
      fd.append(
        'data',
        `Insert into btn_tv_iklan (text) VALUES ('${this.vdata.text}')`
      )
    ...
    update () {
      ...
      fd.append(
        'data',
        `UPDATE btn_tv_iklan SET text='${this.vdata.text}' Where id = '${this.vdata.id}'`
      )
      fd.append('database', ' infolay3_test')
    ...
    remove () {
      ...
      fd.append(
        'data',
        `DELETE FROM btn_tv_iklan WHERE  id =  '${this.vdata.id}'`
      )
      fd.append('database', ' infolay3_test')
    ...
    refreshData () {
      ...
      fd2.append('data', 'select * from btn_tv_iklan') // if empty = *
      fd2.append('table', 'btn_tv_iklan')
