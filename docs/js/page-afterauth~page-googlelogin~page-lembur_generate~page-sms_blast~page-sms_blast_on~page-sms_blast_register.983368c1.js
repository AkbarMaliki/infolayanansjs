 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(function(t){t[t["UNKNOWN"]=0]="UNKNOWN",t[t["VISIBLE"]=1]="VISIBLE",t[t["HIDDEN"]=2]="HIDDEN"})(P||(P={}));var D=["firebase_","google_","ga_"],B=new RegExp("^[a-zA-Z]\\w*$"),K=40,q=100;function V(){var t=F.getInstance().navigator;return"serviceWorker"in t?t.serviceWorker.controller?2:3:1}function z(){var t=F.getInstance().document,e=t.visibilityState;switch(e){case"visible":return P.VISIBLE;case"hidden":return P.HIDDEN;default:return P.UNKNOWN}}function x(){var t=F.getInstance().navigator,e=t.connection,n=e&&e.effectiveType;switch(n){case"slow-2g":return 1;case"2g":return 2;case"3g":return 3;case"4g":return 4;default:return 0}}function $(t){if(0===t.length||t.length>K)return!1;var e=D.some((function(e){return t.startsWith(e)}));return!e&&!!t.match(B)}function J(t){return 0!==t.length&&t.length<=q}
/**
 * @license
 * Copyright 2019 Google LLC
 *
